...
# features/support/netrecorder.rb
  ...
  Before do
    scenario = @__cucumber_step_mother.instance_variable_get("@current_scenario").instance_variable_get("@name")
    if NetRecorder.recording?
      NetRecorder.scope = scenario
    else
      FakeWeb.clean_registry
      NetRecorder.fakeweb(scenario)
    end
  end  
