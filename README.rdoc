...
I'm still learning how to host gems properly on gemcutter, so for now just install from the source.
  
  >> git clone http://github.com/tombombadil/netrecorder.git
  >> cd netrecorder
  >> rake install
